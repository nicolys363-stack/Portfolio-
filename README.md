...
**Estudante de Sistemas de Informação • Bolsista 100% • Desenvolvedora Web**
...
O portfólio consolida sua trajetória acadêmica na graduação em **Sistemas de Informação (2º semestre, Bolsista 100%)**, suas qualificações profissionais pelo **SENAI** e **SENAC**, além de seus principais projetos práticos desenvolvidos na área de desenvolvimento web e aplicações.
...
- **Formações:** Graduação em Sistemas de Informação (em andamento), Cursos SENAI & SENAC.
