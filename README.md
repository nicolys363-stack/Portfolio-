...
O portfólio consolida sua trajetória acadêmica na graduação em **Ciência da Computação na FIAP (Bolsista 100%)**, suas qualificações profissionais pelo **SENAI** e **SENAC**, além de seus principais projetos práticos desenvolvidos na área de desenvolvimento web e aplicações.
